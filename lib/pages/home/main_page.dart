...
import 'package:goodeeps2/pages/bruxism_history.dart';
import 'package:goodeeps2/update_screen.dart';
import 'package:http/http.dart' as http;
import 'package:goodeeps2/pages/account_confirmation_page.dart';
import 'package:goodeeps2/pages/bluetooth_connection_page.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      bluetoothStatus = await FlutterBluePlus.isOn;
  ...
  void processSingleDataPoint(String dataPoint) async {
    /*
      4ms EMG DATA
      smaple : a5 05 16 0f 87 00 3a 00 d0 01 39 08 00 a6 23 04 3d 5a
    */
    ...
    /*
      ...
      5000 = 20s 사이즈로 저장하고 지우고를 반복함
      해당 단위가 높을 수록 메모리 용량을 많이 차지함

      250/1ms


      5000 000/20s
      a5 05 16 0f 87 00 3a 00 d0 01 39 08 00 a6 23 04 3d 5a = 250/4s
